<template>
  ...
  <ion-content class="ion-padding">
    <div class="message-void" v-if="!acts?.length">
      PARECE QUE ESTA CARTILLA NO TIENE CONDICIONES REGITRADAS
    </div>
    <ion-grid v-else>
...
import ViewConditionCategory from "../todocartilla/ViewConditionCategory.vue";
  ...
  setup(props, { emit }) {
    ...
    const openActModal = (selectedAct: number) => {
      ...
      props.acts?.forEach((obj) => {
        if (obj.sub_condition_id.act_id.id === selectedCategory.value.id) {
